...
_DELIV_PATTERNS = [
    ...
    # Whose mailbox wins over everything below: an account registered on
    # the BUYER's email is own even when the seller creates it
    # ("Создание аккаунта на вашу почту" => own).
